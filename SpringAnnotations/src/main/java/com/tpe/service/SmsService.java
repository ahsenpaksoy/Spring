...
//@Component:bu classın objeleri Spring tarafından oluşturulur ve spring tarafından yönetilir ve bu objelere Spring Bean adı verilir.
public class SmsService implements MessageService{

    //field injection

   // @Autowired //bağımlılığın enjekte edilmesini sağlar.Otomatik olarak baglantıyı gerceklestirir.
   // @Qualifier("fileRepository")// birden fazla aynı data tipinde bean varsa belirleyici görevini görür.belirleyici,secim yapıcı
   // private Repository repo; //repository yi implemente edib dbrepository yi enjekte etti
