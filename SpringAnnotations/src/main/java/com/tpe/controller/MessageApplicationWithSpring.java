...
public class MessageApplicationWithSpring {
    public static void main(String[] args) {
        ...
        //AnnotationConfigApplicationContext:config classını okur ve componentscan ile componentları ve beanleri tarar ve her birinden
        ...
        //mesajı sms ile gonderelim: smsservice in objesi gerekli
        MessageService service1 = context.getBean(SmsService.class); //newlemedik, rica ettik
        service1.sendMessage(message);

        //parent ı kullandıysak bean in ismiyle belirtmemiz gerekiyor
        ...
        //random bir deger uretelim ve yazdıralım
...
Prototype: Kısa ömürlü nesneler için kullanışlıdır, ancak manuel olarak yönetilmesi gerekebilir. Özellikle Spring konteynerinin
dışında kullanılan prototip nesnelerin yaşam döngüsüne dikkat edilmelidir.
 */
